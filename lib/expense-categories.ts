...
export const EXPENSE_CATEGORIES: ExpenseCategory[] = [
  ...
  { value: 'moveis_eletrodomesticos', label: 'Móveis e eletrodomésticos', group: 'Moradia', bucket: 'essential' },
  { value: 'diarista', label: 'Diarista e serviços domésticos', group: 'Moradia', bucket: 'essential' },
  ...
  { value: 'seguranca_residencial', label: 'Segurança residencial', group: 'Contas da casa', bucket: 'essential' },
  ...
  { value: 'refeicao_trabalho', label: 'Refeição no trabalho', group: 'Alimentação', bucket: 'essential' },
  ...
  { value: 'estacionamento_pedagio', label: 'Estacionamento e pedágio', group: 'Transporte', bucket: 'essential' },
  { value: 'financiamento_veiculo', label: 'Financiamento do veículo', group: 'Transporte', bucket: 'essential' },
  ...
  { value: 'academia_esporte', label: 'Academia e esporte', group: 'Saúde', bucket: 'desire' },
  ...
  { value: 'livros', label: 'Livros e materiais de estudo', group: 'Educação', bucket: 'desire' },
  ...
  { value: 'cuidador', label: 'Cuidador e apoio familiar', group: 'Família', bucket: 'essential' },
  ...
  { value: 'beleza', label: 'Beleza e cuidados pessoais', group: 'Desejos', bucket: 'desire' },
  { value: 'hobbies', label: 'Hobbies', group: 'Desejos', bucket: 'desire' },
  ...
  { value: 'seguro_vida', label: 'Seguro de vida', group: 'Financeiro', bucket: 'financial' },
  { value: 'impostos', label: 'Impostos e taxas', group: 'Financeiro', bucket: 'financial' },
  { value: 'emprestimo_familiar', label: 'Empréstimo para familiar', group: 'Financeiro', bucket: 'financial' },
  { value: 'trabalho_negocio', label: 'Trabalho ou pequeno negócio', group: 'Trabalho e renda', bucket: 'essential' },
  { value: 'ferramentas_trabalho', label: 'Ferramentas de trabalho', group: 'Trabalho e renda', bucket: 'essential' },
  { value: 'divulgacao_vendas', label: 'Divulgação e vendas', group: 'Trabalho e renda', bucket: 'essential' },
  { value: 'religiao_comunidade', label: 'Religião e comunidade', group: 'Outros', bucket: 'desire' },
